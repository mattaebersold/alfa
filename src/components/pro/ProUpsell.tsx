...
export const PRO_BENEFITS = [
  ...
  'Unlimited marketplace listings — no monthly cap',
  'List diecast in the marketplace — a Pro-only category',
  '20 custom alerts — get told the moment a part for your car is listed',
  'Create groups',
